...
// and avoid common 'ServiceWorker script evaluation failed' errors on subdirectories.

// Define the base path for your repository
const REPO_BASE_PATH = '/schoolhakz/';

// Define Ultraviolet config (must be available globally before UV code)
self.__uv$config = {
    prefix: REPO_BASE_PATH + 'service/', // Full path for prefix
    bare: 'https://bare.benrogo.net/', // Your bare server URL
    encodeUrl: (str) => btoa(str),
    decodeUrl: (str) => atob(str),
    handler: REPO_BASE_PATH + 'uv/uv.handler.js',
    client: REPO_BASE_PATH + 'uv/uv.client.js',
    bundle: REPO_BASE_PATH + 'uv/uv.bundle.js', // This path might be less relevant now, but keep for consistency
    config: REPO_BASE_PATH + 'uv/uv.config.js', // This path might be less relevant now
    sw: REPO_BASE_PATH + 'uv/uv.sw.js',         // This path might be less relevant now
};

// ==============================================================================
// === START OF EMBEDDED ULTRAVIOLET BUNDLE CONTENT (from uv.bundle.js) ===
// ==============================================================================
// Copy and paste the ENTIRE MINIFIED CONTENT of uv.bundle.js here.
...
(function() {
    ...
    var m = self.Ultraviolet,
        ...
        A = self.__uv$config,
        k = self.__uv$cookies;
    if (typeof k != "string") throw new TypeError("Unable to load global UV data");
    self.__uv || p(self);
    self.__uvHook = p;

    function p(o) {
        if ("__uv" in o && o.__uv instanceof m) return !1;
        ...
        let h = !o.window,
            ...
            e = new m(A),
            c;
        h ? c = new m.BareClient(new Promise(t => {
            addEventListener("message", ({
                data: r
            }) => {
                typeof r == "object" && "__uv$type" in r && r.__uv$type === "baremuxinit" && t(r.port)
            })
        })) : c = new m.BareClient;
        let a = new W(o, c, h),
            {
        ...
        a.nativeMethods.defineProperty(o, "__uv", {
            value: e,
            enumerable: !1
        }), e.meta.origin = location.origin, e.location = a.location.emulate(t => t === "about:srcdoc" ? new URL(t) : (t.startsWith("blob:") && (t = t.slice(5)), new URL(e.sourceUrl(t))), t => e.rewriteUrl(t));
        let u = k;
        ...
        a.nativeMethods.defineProperty(e.meta, "base", {
            get() {
                return o.document ? (a.node.baseURI.get.call(o.document) !== d && (d = a.node.baseURI.get.call(o.document), P = e.sourceUrl(d)), P) : e.meta.url.href
            }
        }), e.methods = {
            ...
            parent: i + "parent",
            top: i + "top"
        }, e.filterKeys = [b, e.methods.setSource, e.methods.source, e.methods.location, e.methods.function, e.methods.string, e.methods.eval, e.methods.parent, e.methods.top, i + "protocol", i + "storageObj", i + "url", i + "modifiedStyle", i + "config", i + "dispatched", "Ultraviolet", "__uvHook"], a.on("wrap", (t, r) => {
            ...
            let r = t.data.origin,
                l = e.call;
            t.that && (l = t.that.__uv$source.call), t.data.origin = "*", t.data.message = {
                __data: t.data.message,
            ...
            if (t.that instanceof g && t.data.name === "src" && t.data.value.startsWith("blob:")) {
                t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.blobUrls.get(t.data.value);
                return
            }
            e.attrs.isUrl(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteUrl(t.data.value)), e.attrs.isStyle(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteCSS(t.data.value, {
                context: "declarationList"
            })), e.attrs.isHtml(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteHtml(t.data.value, { ...e.meta,
                document: !0,
                injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, u, o.location.href)
            })), e.attrs.isSrcset(t.data.name) && (t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.html.wrapSrcset(t.data.value.toString()))
        }), a.element.on("audio", t => {
            t.data.url = e.rewriteUrl(t.data.url)
        }), a.element.hookProperty([L, O, T, E], "href", {
            get: (t, r) => e.sourceUrl(t.call(r)),
            set: (t, r, [l]) => {
                a.element.setAttribute.call(r, e.attributePrefix + "-attr-href", l), t.call(r, e.rewriteUrl(l))
            }
        }), a.element.hookProperty([y, M, j, g, _, v, H, n, x, S], "src", {
            get: (t, r) => e.sourceUrl(t.call(r)),
            set: (t, r, [l]) => {
                if (new String(l).toString().trim().startsWith("blob:") && r instanceof g) return a.element.setAttribute.call(r, e.attributePrefix + "-attr-src", l), t.call(r, e.blobUrls.get(l) || l);
                a.element.setAttribute.call(r, e.attributePrefix + "-attr-src", l), t.call(r, e.rewriteUrl(l))
            }
        }), a.element.hookProperty([$], "action", {
            get: (t, r) => e.sourceUrl(t.call(r)),
            set: (t, r, [l]) => {
                a.element.setAttribute.call(r, e.attributePrefix + "-attr-action", l), t.call(r, e.rewriteUrl(l))
            }
        }), a.element.hookProperty([_, S], "srcset", {
            get: (t, r) => a.element.getAttribute.call(r, e.attributePrefix + "-attr-" + "srcset") || t.call(r),
            set: (t, r, [l]) => {
                a.element.setAttribute.call(r, e.attributePrefix + "-attr-" + "srcset", l), t.call(r, e.html.wrapSrcset(l.toString()))
            }
        ...
        if (a.element.hookProperty(n, "contentWindow", {
                ...
                t.data.string = e.rewriteHtml(t.data.string, { ...e.meta,
                    document: !0
                })
            }), a.attribute.on("getValue", t => {
                a.element.hasAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name) && t.respondWith(a.element.getAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name))
            }), a.attribute.on("setValue", t => {
                e.attrs.isUrl(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteUrl(t.data.value)), e.attrs.isStyle(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteCSS(t.data.value, {
                    context: "declarationList"
                })), e.attrs.isHtml(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.rewriteHtml(t.data.value, { ...e.meta,
                    document: !0,
                    injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, u, o.location.href)
                })), e.attrs.isSrcset(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value), t.data.value = e.html.wrapSrcset(t.data.value.toString()))
            }), a.element.on("audio", t => {
                t.data.url = e.rewriteUrl(t.data.url)
            }), a.element.hookProperty([L, O, T, E], "href", {
                get: (t, r) => e.sourceUrl(t.call(r)),
            ...
            let D = n && Object.getOwnPropertyDescriptor(n.prototype, "contentWindow").get;
            ...
            if (a.element.hookProperty(n, "contentWindow", {
                ...
                if (a.element.hookProperty(n, "contentWindow", {
                    ...
                    if (a.element.hookProperty(n, "contentWindow", {
                        ...
                        let B = n && Object.getOwnPropertyDescriptor(n.prototype, "contentWindow").get;
                                    ...
                                    if (a.element.hookProperty(n, "contentWindow", {
                                        ...
                                        if (a.element.hookProperty(n, "contentWindow", {
                                            ...
                                            if (a.element.hookProperty(n, "contentWindow", {
                                                    ...
                                                    set: (t, r, [l]) => {
                                                        if (new String(l).toString().trim().startsWith("blob:") && r instanceof g) return a.element.setAttribute.call(r, e.attributePrefix + "-attr-" + "src", l), t.call(r, e.blobUrls.get(l) || l);
                                                        a.element.setAttribute.call(r, e.
